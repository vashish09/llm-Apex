...
2. The prompt is sent to multiple LLM models using OpenRouter API.
3. Each model processes the prompt.
4. The responses are displayed side-by-side for comparison.
...
## Screenshots
 ...
 # landing page
 ![alt text](<Screenshot 2026-02-26 221807.png>) 

 # chat page 
 ![alt text](<Screenshot 2026-02-26 221853.png>)

 # output 
 ![alt text](<Screenshot 2026-02-26 221956.png>)
